  ...
  const successCases = [
    {
      ...
      results: [
        "300% increase in total sales within 6 months",
        "Expanded customer base beyond local market",
        "Achieved Mercado Livre Gold Seller status in under a year"
      ],
    ...
    },
    {
      ...
      results: [
        "450% year-over-year growth in online revenue",
        "Smoothed out seasonal sales through strategic planning",
        "Expanded product catalog from 50 to 200 items"
      ],
    ...
    },
    {
      ...
      results: [
        "40% reduction in return rates through improved listings",
        "Inventory turnover increased by 60%",
        "Customer satisfaction score improved from 3.2/5 to 4.8/5"
      ],
    ...
    <>
      ...
      <div className="bg-proximanova-blue pt-32 pb-16 md:pt-36 md:pb-20 text-white">
        <div className="container mx-auto text-center">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Success Cases</h1>
          <p className="text-xl max-w-3xl mx-auto mb-6">
            Real results from businesses that partnered with Próxima Nova in their digital transformation journey.
          </p>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-proximanova-blue">Client Success Stories</h2>
            </div>
            <div className="h-1 w-16 bg-proximanova-yellow mx-auto mb-6"></div>
            <p className="text-gray-700 max-w-3xl mx-auto">
              Discover how businesses across different industries achieved remarkable results 
              by implementing our digital transformation solutions.
            </p>
          </div>
          ...
          {successCases.map((caseStudy, index) => (
            <div 
              key={index}
              className={`mb-24 ${index !== successCases.length - 1 ? "border-b border-gray-200 pb-24" : ""}`}
            >
