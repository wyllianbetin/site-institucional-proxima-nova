          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-700 mb-8">
                Fill out the form below and one of our specialists will contact you soon to discuss how 
                we can help your business thrive in the digital marketplace.
              </p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="space-y-3">
                  {[
                    "Expert guidance on digital transformation",
                    "Customized solutions for your business",
                    "Proven results with hundreds of retailers",
                    "Comprehensive ecosystem approach",
                    "Specialized in marketplace success"
                  ].map((item, index) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Digital Retailer Program">Digital Retailer Program</option>
