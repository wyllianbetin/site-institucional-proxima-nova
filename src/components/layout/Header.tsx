...
const Header = () => {
  ...
  return <header className={`fixed w-full top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-2' : 'bg-transparent py-4'}`}>
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="flex items-center">
          <img alt="Próxima Nova Logo" className="h-8 md:h-10 w-auto" src="/lovable-uploads/13d2542d-9454-49e3-9fd5-ec498b96ff51.png" />
        </Link>
