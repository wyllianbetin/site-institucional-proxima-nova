  ...
  return <section className="section bg-gray-50">
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="text-lg max-w-3xl mx-auto text-gray-700">Ajudamos empresas em todos os estágios.
Desde negócios que ainda não vendem online e desejam implementar uma operação de e-commerce, até sellers que já vendem e buscam otimizar e escalar seus resultados.

Confira a solução que melhor se encaixa na sua necessidade.</p>
        </div>
