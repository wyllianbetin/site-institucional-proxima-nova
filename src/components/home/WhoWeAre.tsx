  ...
  return <section className="section bg-white">
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="text-lg max-w-3xl mx-auto text-gray-700">Na Próxima Nova, acreditamos que o presente e o futuro do varejo é cada vez mais digital — e estamos aqui para construir essa transformação ao lado das empresas. Oferecemos um ecossistema completo que viabiliza que lojas físicas, marcas, distribuidores, importadores e fabricantes vendam no Mercado Livre, por meio de tecnologia, treinamentos, gestão, operação e logística. Tudo reunido em um único parceiro estratégico. Nosso time é formado por consultores certificados, especialistas em marketplaces e profissionais operacionais, prontos para cuidar de todas as etapas das vendas online de nossos parceiros. Mais do que uma consultoria ou assessoria, somos um fullcommerce. Nós orientamos, cuidamos, executamos e entregamos resultados. Somos comprometidos em proporcionar crescimento real e sustentável para cada empresa que confia na nossa expertise. Nossa missão é simples: Transformar o potencial do varejo tradicional em histórias de sucesso no universo do varejo digital. Bem-vindo à Próxima Nova. O sucesso das suas vendas online começa aqui.</p>
        </div>
