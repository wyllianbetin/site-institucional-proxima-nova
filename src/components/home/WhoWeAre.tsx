...
O sucesso das suas vendas online começa aqui.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 stats-section">
          <div className="text-center">
            <div className="h-24 w-40 mx-auto bg-gray-100 flex items-center justify-center mb-4 shadow-sm border border-gray-200 transition-all hover:shadow-md rounded-full">
          ...
          <div className="text-center">
            <div className="h-24 w-40 mx-auto bg-gray-100 flex items-center justify-center mb-4 shadow-sm border border-gray-100transition-all hover:shadow-md rounded-full">
