...
const EcosystemSection = () => {
  ...
  return (
    <section className="section bg-[#f5f4e2] py-10 md:py-16">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center mb-8">
          <div className="bg-proximanova-blue/10 p-3 rounded-full mb-3">
            <Layers className="h-6 w-6 text-proximanova-blue" />
          </div>
          <h2 className="text-2xl md:text-3xl font-bold text-proximanova-blue mb-2">
            Ecossistema Próxima Nova
          </h2>
          <div className="h-1 w-20 bg-proximanova-yellow mb-4"></div>
